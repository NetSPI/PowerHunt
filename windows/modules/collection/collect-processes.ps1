...
# Module : collect-processes
# Version: 1.0
# Author : Scott Sutherland
# Summary: This is script is part of the PowerHunt framework and collect process information.
...
# /////////////////////////////////////////////////////
    ...
    # Check process
	$FinalOutput = Get-WMIObject Win32_Process | Select name,ProcessId,description, commandline,creationdate |
    foreach{
